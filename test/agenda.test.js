...
//     const newUser= ["ElenaMarco3", "Elena", "Marco", "email", "phone"]
//     const path1 = path.resolve(__dirname, '../lib/agenda.json')
//     it ("writes new user",()=>{
//         const data = saveUser(newUser, path1)
//         const loadedData = db.load(path1)
//         expect(loadedData[newUser[0]].username).toEqual("ElenaMarco3")
//     })
//     it ("works when user is duplicated", ()=>{
//         newUser2 = ["ElenaMarco", "Elena", "Marco", "email", "phone"]
//         expect(()=>{
//             saveUser(newUser2,path1)
