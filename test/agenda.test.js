...
describe ("Add activity function",()=>{
    ...
    it ("works adding activity",()=>{       
        expect(expUserAct).toEqual({username:"username", name:"Elena", lastName:"Marco", email: "elenamarco96@gmail.com", phone: "610976608", activityList: ["work", "monday", "9:00"]})
        
    })
    it ("works adding another activty", ()=>{
        const expNewAct = addActivity(expUserAct, ...newActivity2)
        expect(expNewAct).toEqual({username: "username",name:"Elena", lastName:"Marco", email: "elenamarco96@gmail.com", phone: "610976608", activityList: ["work", "monday", "9:00","home", "tuesday", "18:00"]})

    })

})
//describe ("Save user function",()=>{
  //  const newUser= ["ElenaMarco","Elena", "Marco", "elenamarco96@gmail.com", "610976608"]
    //it ("adds user",()=>{
      //  const data = saveUser(newUser)
        //expect(data).toEqual([{username: "LastName",name:"Elena", lastName:"Marco", email: "elenamarco96@gmail.com", phone: "610976608", activityList: ["work", "monday", "9:00","home", "tuesday", "18:00"]}])
    //})
//})